...
public class login2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.add(softvets, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 170, 40));

        jSeparator1.setForeground(new java.awt.Color(0, 153, 153));
        bg.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 1010, 10));

        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ventana/imagenlogo/Green Modern Veterinary Clinic Logo (4).png"))); // NOI18N
        logo.setToolTipText("");
        bg.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 70, 890, 230));
        ...
        bg.add(header, new org.netbeans.lib.awtextra.AbsoluteConstraints(-40, 0, 980, 40));
        ...
        bg.add(exitBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 0, -1, -1));
