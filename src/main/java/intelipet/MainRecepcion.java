...
/**
 *
 * La clase MainRecepcion es la clase principal de la aplicación de recepción de
...
public class MainRecepcion extends Application {
    ...
    /**
     *
     * Inicia la aplicación de JavaFX con LoginRecepción.
     *
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.show();
        loginRecepcionController.handleLogin(new ActionEvent()); // Llamamos al método handleLogin() con un evento vacío
    }
